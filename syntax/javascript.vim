...
syn keyword javaScriptCommentNote      NOTE contained
syn keyword javaScriptCommentWarning   WARNING contained
syn match   javaScriptLineComment      "\/\/.*" contains=@Spell,javaScriptCommentTodo,javaScriptCommentNote,javaScriptCommentWarning
syn match   javaScriptCommentSkip      "^[ \t]*\*\($\|[ \t]\+\)"
syn region  javaScriptComment	       start="/\*"  end="\*/" contains=@Spell,javaScriptCommentTodo,javaScriptCommentNote,javaScriptCommentWarning
...
hi def link javaScriptCommentNote		Note
hi def link javaScriptCommentWarning	Warning
