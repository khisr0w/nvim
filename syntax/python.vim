...
syn match   pythonComment	"#.*$" contains=pythonTodo,pythonNote,pythonWarning,@Spell
syn keyword pythonTodo		FIXME TODO XXX contained
syn keyword pythonWarning	WARNING contained
...
hi def link pythonWarning		Warning
hi def link pythonNote			Note
