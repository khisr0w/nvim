...
syn keyword	cWarning	contained WARNING 
...
if !exists("c_no_ansi") || exists("c_ansi_typedefs")
  syn keyword   cType		size_t usize ssize_t off_t wchar_t ptrdiff_t sig_atomic_t fpos_t
  syn keyword   cType		clock_t time_t va_list jmp_buf FILE DIR div_t ldiv_t
  syn keyword   cType		mbstate_t wctrans_t wint_t wctype_t
endif
if !exists("c_no_c99") " ISO C99
  syn keyword	cType		_Bool bool b32 _Complex complex _Imaginary imaginary
...
syn keyword	cStorageClass	static register auto volatile extern const global_var local_persist internal
if exists("c_gnu")
